// Set URL for geojson API:
var earthquakeURL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";

var tectonicPlatesURL = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";

// GET request to the usgs_URL
...
function createFeatures(earthquakeData) {
  ...
  // Give each feature a popup with earthquake information (magnitude, place, and time)
  ...
  // CreateMap function with Earthquake layer 
...
function createMap(earthquake) {
  ...
  var comic = L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}", {
    ...
    var plate_techtonics = new L.LayerGroup();

    // Create overlay object for earthquake and plate techtonics
    var overlayMaps = {
      "Earthquakes": earthquake,
      "Plate Tectonics": plate_techtonics
    };
    ...
    var myMap = L.map("map", {
      center: [
        37.77, -122.43],
      zoom: 4.5,
      layers: [satellite, earthquake, plate_techtonics]
    }); 

    // Add Fault lines data
    d3.json(tectonicPlatesURL, function(plateData) {
      // Adding our geoJSON data, along with style information, to the tectonicplates toggled on
      // layer.
      L.geoJson(plateData, {
        color: "gold",
        weight: 3
      })
      .addTo(plate_techtonics);
  });
